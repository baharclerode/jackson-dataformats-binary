    ...
    implements SchemaBuilder
{
    ...
    public Schema builtAvroSchema() {
        ...
        AnnotatedClass ac = _provider.getConfig().introspectClassAnnotations(_type).getClassInfo();
        if (_enums != null) {
            Schema s = Schema.createEnum(AvroSchemaHelper.getName(_type),
                                         _provider.getConfig().getAnnotationIntrospector().findClassDescription(ac),
